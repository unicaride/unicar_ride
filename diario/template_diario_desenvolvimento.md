...
- [Figma de baixa funcionalidade ] - [Link para o repositório ou localização]
...
-  (17/05/25)Considerações de Acessibilidade - [Implementado acesseiblidade no prototipo no figma.Cores mudadas, iconis de acessibilidade implemendato.Ducumento entrega no moodle]
- Elaboração de Guia de Estilo Básico - [enviado um documento com os tamanhos das fontos usada, cores usadas, icones e elementos grafico][
